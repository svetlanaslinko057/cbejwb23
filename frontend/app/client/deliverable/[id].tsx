...
const s = StyleSheet.create({
  ...
  actionsRow: { flexDirection: 'row', gap: 8, paddingHorizontal: 16, paddingVertical: 14, backgroundColor: T.surface, flexWrap: 'wrap' },
  actionBtn: { flex: 1, flexBasis: '48%', minWidth: 140, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingVertical: 13, paddingHorizontal: 10, borderRadius: 12 },
  actionBtnPrimary: { backgroundColor: T.primary },
  actionBtnPrimaryText: { color: T.primaryInk, fontWeight: '600', fontSize: 14, flexShrink: 1, textAlign: 'center' },
  actionBtnGhost: { borderWidth: 1, borderColor: T.borderStrong, backgroundColor: 'transparent' },
  actionBtnGhostText: { color: T.text, fontWeight: '600', fontSize: 14, flexShrink: 1, textAlign: 'center' },
  ...
  modalActions: { flexDirection: 'row', gap: 8, padding: 16, borderTopWidth: 1, borderColor: T.border, backgroundColor: T.surface, flexWrap: 'wrap' },
  modalBtn: { flex: 1, flexBasis: '48%', minWidth: 130, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingVertical: 12, paddingHorizontal: 10, borderRadius: 12 },
  modalBtnGhost: { borderWidth: 1, borderColor: T.border },
  modalBtnGhostText: { color: T.textMuted, fontWeight: '500', flexShrink: 1, textAlign: 'center' },
  modalBtnPrimary: { backgroundColor: T.primary },
  modalBtnPrimaryText: { color: T.primaryInk, fontWeight: '600', flexShrink: 1, textAlign: 'center' },
  modalBtnWarning: { backgroundColor: T.warning },
  modalBtnWarningText: { color: '#fff', fontWeight: '600', flexShrink: 1, textAlign: 'center' },
});
