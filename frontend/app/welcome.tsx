  ...
  return (
    ...
    >
      ...
      <View style={s.brand} testID="welcome-brand">
        ...
        />
        {/* Compact, unobtrusive language switcher. Default EN; persists choice via i18n provider. */}
        <View style={s.langSwitch} testID="welcome-lang-switch">
          <Pressable
            onPress={() => setLang('en')}
            style={[s.langPill, lang === 'en' && s.langPillActive]}
            testID="welcome-lang-en"
          ...
          <Pressable
            onPress={() => setLang('uk')}
            style={[s.langPill, lang === 'uk' && s.langPillActive]}
            testID="welcome-lang-uk"
            accessibilityLabel="Українська"
          >
            <Text style={[s.langPillText, lang === 'uk' && s.langPillTextActive]}>UK</Text>
          </Pressable>
        </View>
      </View>
...
const s = StyleSheet.create({
  ...
  /* Compact language switch — pill pair, sits opposite the brand mark */
  langSwitch: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
